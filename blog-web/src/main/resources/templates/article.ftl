                ...
                <div class="cat">
                    <ul class="list-unstyled">
                        ...
                        <li>
                            ...
                            <#if article.original?string('true','false') == 'true'>
                                本站原创文章，于${article.createTime?string('yyyy年MM月dd日')}
                                <a href="${config.siteUrl}" target="_blank" data-original-title="${config.siteName}" data-toggle="tooltip" data-placement="bottom">
                            </a>发布，转载请注明出处
                            <#else>
